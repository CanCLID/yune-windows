...
if ($AuditPath -eq "") {
    $AuditPath = Join-Path $RepoRoot "docs\evidence\m01\closeout\audit.json"
}
if ($OutputPath -eq "") {
    $OutputPath = Join-Path $RepoRoot "docs\evidence\m01\installer\approval-brief.md"
}
...
$Lines.Add("# M01 Approval Brief") | Out-Null
$Lines.Add("") | Out-Null
...
$Lines.Add("A passing validation writes prep-preflight-ready; it does not install, register, launch apps, clean residue, or close M01.") | Out-Null
$Lines.Add("") | Out-Null
$Lines.Add('```powershell') | Out-Null
...
$Lines.Add('```') | Out-Null
$Lines.Add("") | Out-Null
$Lines.Add("This brief is non-mutating advisory evidence and does not close M01.") | Out-Null
