...
if ($OutputDir -eq "") {
    $OutputDir = Join-Path $env:TEMP "yune-windows\m01-audit-quality-test"
}
...
Write-EvidenceFile "m01\tsf-smoke\chromium-smoke-result.md" "Pass: True"
Write-EvidenceFile "m01\installer\result.md" "Fresh install: attempted"
