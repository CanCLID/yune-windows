# M01 Windows Product Implementation Plan
...
- `tools\test-live-smoke-preflight-readiness-gate.ps1` verifies live preflight
  ...
  app automation.
- `tools\write-m01-approval-brief.ps1` and
  `tools\test-approval-brief-contract.ps1` maintain the operator approval
  brief path at `docs\evidence\m01\installer\approval-brief.md`.
- `tools\clear-yune-windows-machine-residue.ps1` and
  ...
  `docs\evidence\m01\installer\machine-cleanup-after.json`, and
  `docs\evidence\m01\installer\machine-cleanup-result.md`.
- `tools\collect-m01-compatibility-environment.ps1` and
  `tools\test-compatibility-environment-evidence.ps1` regenerate
  `docs\evidence\m01\installer\compatibility-environment.json`.
- `tools\test-product-hardening-evidence-contract.ps1` checks regenerated
  compatibility and signing docs at
  `docs\evidence\m01\installer\compatibility-matrix.md` and
  `docs\evidence\m01\installer\signing-decision.md`.
- `tools\test-webview2-feasibility.ps1` checks regenerated settings evidence
  at `docs\evidence\m01\settings\webview2-spike.md`.
- `tools\test-live-smoke-preflight-evidence.ps1` checks regenerated preflight
  evidence at `docs\evidence\m01\installer\live-preflight.json` and
...
- `tools\test-chromium-smoke-plan-exact-structural-evidence.ps1` checks the
  ...
  `docs\evidence\m01\tsf-smoke\chromium-smoke-plan.md`.
...
M01 has the core Yune Windows development path working: packaged Yune,
