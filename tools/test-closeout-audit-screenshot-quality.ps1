...
if ($OutputDir -eq "") {
    $OutputDir = Join-Path $env:TEMP "yune-windows\p2-win01-audit-screenshot-quality-test"
}
...
foreach ($Screenshot in @(
    "p2-win01-tsf-smoke\candidate-display-notepad.png",
    "p2-win01-tsf-smoke\notepad-commit.png",
    "p2-win01-tsf-smoke\candidate-display-chromium.png",
    "p2-win01-tsf-smoke\chromium-commit.png"
)) {
