...
if ($OutputDir -eq "") {
    $OutputDir = Join-Path $env:TEMP "yune-windows\m01-audit-diagnostics-quality-test"
}
...
"@
Write-DiagnosticsBundleWithoutStructuralLogs "m01\settings\registered-session-diagnostics\missing-structural-log.zip"
